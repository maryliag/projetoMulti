    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        protected void LoadGraphicsContent(bool loadAllContent)
        {
            if (loadAllContent)
            {
                ...
                //mSmile = aLoader.Load<Texture2D>("smile.jpg") as Texture2D;
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            //mBatch.Draw(mSmile, new Rectangle(this.Window.ClientBounds.Width / 2 - mSmile.Width / 2, 30, mSmile.Width, 44), new Rectangle(0, 45, mSmile.Width, 44), Color.Red);


            //Draw the box around the health bar
            //mBatch.Draw(mSmile, new Rectangle(this.Window.ClientBounds.Width / 2 - mSmile.Width / 2,
            //      30, mSmile.Width, 44), new Rectangle(0, 0, mSmile.Width, 44), Color.White);
